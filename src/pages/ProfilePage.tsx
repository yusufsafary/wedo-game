...
export default function ProfilePage() {
  ...
  // First letter / initials for avatar
    ...
    <div className="px-5 py-5 flex flex-col gap-5 pb-6">
      ...
      >
        <div className="relative">
          <div
            className="w-[60px] h-[60px] rounded-2xl flex items-center justify-center text-2xl font-extrabold text-white flex-shrink-0"
            style={{
      ...
      <motion.div
        ...
        className="relative z-10 flex items-center justify-between mt-1 px-3 py-2.5 rounded-2xl"
